	...
	<table width="1238" height="530" border="0">
		<tr>
			...
			<td height="119" colspan="2" bgcolor="#006600">
				<h1><center><font color="#FFFFFF">บ่าวเทือนอพาร์ตเมนท์</font></center></h1>
		...
		<tr>
			...
			<td width="190" bgcolor="#FFFF66"><ul>
				...
				<li><a href="contact.php">ติดต่อvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv</li>
				</ul><p>
